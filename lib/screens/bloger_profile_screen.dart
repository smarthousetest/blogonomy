      ...
      if (state is OneBlogerLoadedState) {
        ...
        return StatefulBuilder(// StatefulBuilder
          ...
          return BlocBuilder<AuthCubit, AuthState>(
            builder: (context, state) {
              print("sus stae $state");

              if (state is LogoutedState || state is EmptyState) {
                return Scaffold(
                  appBar: AppBar(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              prefix.PieChart(
                                                dataMap: {
                                                  "Women": state.loadedBloger
                                                      ?.sexRatio.women
                                                      .roundToDouble(),
                                                  "Men": state.loadedBloger
                                                      ?.sexRatio.men
                                                      .roundToDouble()
                                                },
                                                animationDuration:
                                                ...
                                                legendOptions:
                                                    prefix.LegendOptions(
                                                  showLegends: false,
                                                ),
                                                chartValuesOptions:
                                                    prefix.ChartValuesOptions(
